...
public class demo2{
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "我的测试邮件_廉千慧", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.addRecipient(RecipientType.TO, new InternetAddress(receiveMail, "我的测试邮件_小可爱", "UTF-8"));
        ...
        DataHandler dh = new DataHandler(new FileDataSource("D:\\one.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("D:\\auto2018\\test-output\\html.zip"));  // 读取本地文件
